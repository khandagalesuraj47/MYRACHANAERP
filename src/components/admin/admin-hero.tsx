      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div className="space-y-1.5">
          <div className="flex items-center gap-2">
            <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-blue-50 border border-blue-200 text-blue-700 text-[11px] font-mono font-bold">
        ...
        <div className="flex items-center gap-2 rounded-xl bg-slate-50 border border-slate-200 px-3.5 py-2 shrink-0 self-start md:self-auto">
          ...
          <div className="flex flex-col text-left">
            ...
            <span className="text-xs font-bold text-slate-800 font-mono">{currentDate}</span>
          </div>
        </div>
      </div>
    </div>
